...
export const editableRootStyle = {
  ...
  '--slot4-page-bg': '#1d0918',
  '--slot4-page-text': '#FFE8B4',
  '--slot4-panel-bg': '#5E244E',
  '--slot4-surface-bg': '#2b1024',
  '--slot4-muted-text': '#e9bd9e',
  '--slot4-soft-muted-text': '#bd806f',
  '--slot4-accent': '#E68457',
  '--slot4-accent-fill': '#AA1C41',
  '--slot4-accent-soft': '#5E244E',
  '--slot4-on-accent': '#FFE8B4',
  '--slot4-dark-bg': '#1d0918',
  '--slot4-dark-text': '#FFE8B4',
  '--slot4-media-bg': '#5E244E',
  '--slot4-cream': '#3a142e',
  '--slot4-warm': '#240b1d',
  '--slot4-lavender': '#FFE8B4',
  '--slot4-gray': '#37122d',
  '--slot4-body-gradient': 'radial-gradient(circle at 15% 10%, rgba(170,28,65,.28), transparent 32%), radial-gradient(circle at 88% 35%, rgba(230,132,87,.16), transparent 28%)',
  '--editable-page-bg': '#1d0918',
  '--editable-page-text': '#FFE8B4',
  '--editable-container': '1240px',
  '--editable-border': '#5E244E',
  '--editable-nav-bg': '#1d0918',
  '--editable-nav-text': '#FFE8B4',
  '--editable-nav-active': '#E68457',
  '--editable-nav-active-text': '#1d0918',
  '--editable-cta-bg': '#AA1C41',
  '--editable-cta-text': '#FFE8B4',
  '--editable-search-bg': '#2b1024',
  '--editable-footer-bg': '#1d0918',
  '--editable-footer-text': '#FFE8B4',
} as CSSProperties
